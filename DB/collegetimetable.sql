...
insert into Show_ values(1,'Spider-man','Electric','1-Jan-2018',200,275);
insert into Show_ values(2,'Spider-man','Grand Rex','1-Jan-2018',200,200);
insert into Show_ values(3,'Avengers','Grand Rex','1-Apr-2018',200,98);
insert into Show_ values(4,'Black Panther','Beverly','1-Jan-2018',200,205);
insert into Show_ values(5,'Black Panther','Grand Rex','1-Jan-2018',300,300);
insert into Show_ values(6,'Passengers','Nitehawk','1-Jan-2018',200,176);
insert into Show_ values(7,'Jurrasic World','Nitehawk','1-Jan-2018',200,176);
insert into Show_ values(8,'Black Panther','Nitehawk','1-Jan-2018',200,219);
insert into Show_ values(9,'Ghost in Shell','Cinnemaworld','1-Jan-2018',200,101);
insert into Show_ values(10,'Black Panther','Grand Rex','1-Jan-2018',200,200);
insert into Show_ values(11,'Jurrasic World','Cinnemaworld','1-Jan-2018',200,188);
...
SELECT moviestar.name from moviestar, starsin where moviestar.gender = 'F' and starsin.movieyear = 2018