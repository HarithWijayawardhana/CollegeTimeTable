 ...
 * @author Isuru
 */
public class Time_Table_Report extends javax.swing.JFrame {

    /**
     * Creates new form Time_Table_Report
     */
    public Time_Table_Report() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("          VIIEW");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(729, 596, 180, 60));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/print.png"))); // NOI18N
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 560, -1, 100));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/time table  management rg.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Time_Table_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Time_Table_Report().setVisible(true);
            }
        });
    }
